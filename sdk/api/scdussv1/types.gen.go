...
type OperationalIntentDetails struct {
	...
	OffNominalVolumes *[]Volume4D `json:"off_nominal_volumes,omitempty"`
...
type PutOperationalIntentDetailsParameters struct {
	...
	OperationalIntent *OperationalIntent `json:"operational_intent,omitempty"`
...
type ConstraintDetails struct {
	...
	Geozone *GeoZone `json:"geozone,omitempty"`
}
...
type GetOperationalIntentTelemetryResponse struct {
	...
	Telemetry *VehicleTelemetry `json:"telemetry,omitempty"`
	...
	NextTelemetryOpportunity *Time `json:"next_telemetry_opportunity,omitempty"`
}
...
type Position struct {
	...
	AccuracyH *PositionAccuracyHorizontal `json:"accuracy_h,omitempty"`

	AccuracyV *PositionAccuracyVertical `json:"accuracy_v,omitempty"`
...
type GeoZone struct {
	...
	Name *TextShortType `json:"name,omitempty"`
	...
	RestrictionConditions *[]ConditionExpressionType `json:"restriction_conditions,omitempty"`
	...
	Reason *[]CodeZoneReasonType `json:"reason,omitempty"`
	...
	OtherReasonInfo *string `json:"other_reason_info,omitempty"`

	// This is an extension point. It allows adding additional attributes of national interest through this element.
	RegulationExemption *CodeYesNoType `json:"regulation_exemption,omitempty"`
	...
	USpaceClass *CodeUSpaceClassType `json:"u_space_class,omitempty"`
	...
	Message *TextShortType `json:"message,omitempty"`

	// Indicates that exemptions from the national or European regulations are allowed in the UAS Zone, that will be detailed via the "message" property.
	AdditionalProperties *GeoZoneAdditionalProperties `json:"additional_properties,omitempty"`
}
...
type Authority struct {
	...
	Service *TextShortType `json:"service,omitempty"`

	// The name or role of a specific person that needs to be contacted within the organisation
	ContactName *TextShortType `json:"contact_name,omitempty"`
	...
	SiteUrl *TextShortType `json:"site_url,omitempty"`
	...
	Email *TextShortType `json:"email,omitempty"`

	// A phone number at which the organisation may be contacted
	Phone *TextShortType `json:"phone,omitempty"`

	// The role of the Authority in relation with the zone.
	Purpose *CodeAuthorityRole `json:"purpose,omitempty"`
	...
	IntervalBefore *string `json:"interval_before,omitempty"`
}
